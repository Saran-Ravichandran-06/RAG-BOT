...
const AnoAI = ({ className = "" }) => {
    ...
    useEffect(() => {
        ...
        // Clear previous elements to handle React StrictMode double invocations
    ...
    return (
        <div ref={containerRef} className={`absolute inset-0 w-full h-full -z-10 overflow-hidden pointer-events-none ${className}`}>
